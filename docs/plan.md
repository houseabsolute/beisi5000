...
State: 352 unit tests passing, svelte-check clean. Universe currently 16,150 exercises across 4 tunings (default 4-string; Quarter rhythm only — enabling other rhythms multiplies the non-agility universe). Walking-exercise, arpeggio, and agility layout scans: 0 cross-string ≥8 fret jumps.
